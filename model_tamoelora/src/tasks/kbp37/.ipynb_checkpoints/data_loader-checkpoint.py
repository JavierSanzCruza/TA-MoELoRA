...
from src.tasks.kbp37.guidelines import GUIDELINES
...
class KBP37DatasetLoader(DatasetLoader):
    """
    A `DatasetLoader` for the kbp37 dataset.
    ...
    RELATION_TO_CLASS_MAPPING = {
        "cities of residence": CityOfResidence,
        "top members employees": TopMembersEmployees,
        "members": MemberOf,
        "alternate names": AlternateName,
        "origin": Origin,
        "state or provinces of residence": StateOrProvinceOfResidence,
        "title of person": TitleOfPerson,
        "spouse": Spouse,
        "city of headquarters": CityOfHeadquarters,
        "founded by": FoundedBy,
        "state or province of headquarters": StateOrProvinceOfHeadquarters,
        "employee of": EmployeeOf,
        "countries of residence": CountryOfResidence,
        "country of birth": CountryOfBirth,
        "founded": Founded,
        "subsidiaries": Subsidiary,
        "country of headquarters": CountryOfHeadquarters
    }
...
class KBP37Sampler(Sampler):
    """
    A data `Sampler` for the kbp37 dataset.

    Args:
        dataset_loader (`KBP37Sampler`):
    ...
    def __init__(
        self,
        dataset_loader: KBP37DatasetLoader,
        task: str = None,
        split: str = "train",
