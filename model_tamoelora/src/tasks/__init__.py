...
TASK_ID_TO_TASKS = {
    ...
    "SCIERC_RE": "src.tasks.scierc",
    "ADECORPUS_RE": "src.tasks.adecorpus",
    "CONLL04_RE": "src.tasks.conll04",
    "SEMEVAL_RE": "src.tasks.semeval",
    "NYT11_RE": "src.tasks.nyt11",
    "KBP37_RE": "src.tasks.kbp37",
    "PHEE_EE": "src.tasks.phee",
    "PHEE_EAE": "src.tasks.phee",
    "GIDS_RE": "src.tasks.gids",
}
...
def task_id_to_prompts(task_id: str) -> str:
    ...
    elif task_id.upper() == "PHEE_EE":
        return "src.tasks.phee.prompts_ed"
    elif task_id.upper() == "PHEE_EAE":
        return "src.tasks.phee.prompts_eae"
...
def task_id_to_guidelines(task_id: str) -> Dict[str, Dict[str, List[str]]]:
    ...
    elif task_id.lower() == "scierc":
        from src.tasks.scierc.guidelines_gold import GUIDELINES

        return GUIDELINES
    elif task_id.lower() == "adecorpus":
        from src.tasks.adecorpus.guidelines_gold import GUIDELINES

        return GUIDELINES
    elif task_id.lower() == "conll04":
        from src.tasks.conll04.guidelines_gold import GUIDELINES

        return GUIDELINES
    elif task_id.lower() == "semeval":
        from src.tasks.semeval.guidelines_gold import GUIDELINES

        return GUIDELINES
    elif task_id.lower() == "nyt11":
        from src.tasks.nyt11.guidelines_gold import GUIDELINES

        return GUIDELINES
    elif task_id.lower() == "kbp37":
        from src.tasks.kbp37.guidelines_gold import GUIDELINES

        return GUIDELINES
    elif task_id.lower() == "phee":
        from src.tasks.phee.guidelines_gold import GUIDELINES

        return GUIDELINES
    elif task_id.lower() == "gids":
        from src.tasks.gids.guidelines_gold import GUIDELINES
