...
from src.tasks.adecorpus.guidelines import GUIDELINES
# from src.tasks.adecorpus.guidelines_gold import EXAMPLES
...
class ADECorpusDatasetLoader(DatasetLoader):
    """
    A `DatasetLoader` for the ADECorpus dataset.
...
class ADECorpusSampler(Sampler):
    """
    A data `Sampler` for the ADECorpus dataset.

    Args:
        dataset_loader (`ADECorpusSampler`):
    ...
    def __init__(
        self,
        dataset_loader: ADECorpusDatasetLoader,
        task: str = None,
        split: str = "train",
