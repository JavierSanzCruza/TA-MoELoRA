...
class ModelArguments:
    ...
    lora_type: Optional[str] = field(
        ...
        metadata={
            "help": (
                "Specify lora type: lora, moelora, ..."
            )
        },
    )
    ...
    lora_nums: Optional[float] = field(
        default=8,
        metadata={"help": "Number of lora experts."},
    )
    ...
    task_embedding_model: str = field(
        default=None,
        metadata={
            "help": (
                "The model to use for task embeddings. If set to None, the model will not be used. Defaults to None."
            )
        },
    )
    ...
    task_dim: int = field(
        default=None,
        metadata={"help": "The dimension of the task embeddings. Defaults to None."},
    )

    turn_off_last_layer_expert: int = field(
        default=None,
        metadata={
            "help": (
                "Whether to turn off the last layer expert. If set to True, the last layer expert will be turned off."
                " Defaults to False."
            )
        },
    )
...
class DataTrainingArguments:
    ...
    task_embedding_path: str = field(
        default=None,
        metadata={
            "help": (
                "The path to the task embeddings. If set to None, the precomputed embeddings will not be used. Defaults to None."
            )
        },
    )
    ...
    task_id_mapping_path: str = field(
        default=None,
        metadata={
            "help": (
                "The path to the task id mapping file. This file is used to map the task names to task ids."
                "The file should be a json file with the following format: {'task_name': task_id}."
            )
        },
    )
    ...
    ttest: bool = field(
        ...
        metadata={
            "help": (
                "Whether to perform a t-test on the predictions. If set to True, we will perform a t-test on the"
                " predictions and save the results in the output directory. Defaults to False."
            )
        },
    )
