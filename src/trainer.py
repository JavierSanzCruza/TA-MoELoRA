...
class CollieTrainer(Seq2SeqTrainer):
    ...
    #     logs = logs.copy() # keep original logs
    #     logs["custom/layer_31_q_proj_lora_route"] = self.model.base_model.model.model.layers[31].self_attn.q_proj.lora_route.weight.norm().item()
    #     logs["custom/layer_31_q_proj_lora_task_projection"] = self.model.base_model.model.model.layers[31].self_attn.q_proj.lora_task_projection.weight.norm().item()
    #     logs["custom/layer_31_q_proj_lora_A"] = self.model.base_model.model.model.layers[31].self_attn.q_proj.lora_A_weight.norm().item()
    #     logs["custom/layer_31_q_proj_lora_B"] = self.model.base_model.model.model.layers[31].self_attn.q_proj.lora_B_weight.norm().item()
    #     super().log(logs)
