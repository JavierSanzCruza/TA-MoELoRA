...
from src.tasks.phee.prompts_eae import EAE_EVENT_DEFINITIONS
from src.tasks.phee.prompts_ed import ED_EVENT_DEFINITIONS
from src.tasks.utils_scorer import EventScorer


class PHEEEventScorer(EventScorer):
    """PHEE Event and argument classification scorer."""
...
class PHEEEventArgumentScorer(EventScorer):
    """PHEE Event and argument classification scorer."""
