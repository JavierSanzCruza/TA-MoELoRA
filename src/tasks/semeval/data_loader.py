...
from src.tasks.semeval.guidelines import GUIDELINES
from ..utils_typing import Entity
from src.tasks.semeval.prompts import (
    ENTITY_DEFINITIONS,
...
class SemEvalDatasetLoader(DatasetLoader):
    """
    A `DatasetLoader` for the SemEval dataset.
    ...
    RELATION_TO_CLASS_MAPPING = {
        ...
        "instrument agency": InstrumentAgency,
        "product producer": ProductProducer,
        "content container": ContentContainer,
        "entity origin": EntityOrigin,
        "entity destination": EntityDestination,
        "component whole": ComponentWhole,
        "member collection": MemberCollection,
...
class SemEvalSampler(Sampler):
    """
    A data `Sampler` for the SemEval dataset.

    Args:
        dataset_loader (`SemEvalSampler`):
