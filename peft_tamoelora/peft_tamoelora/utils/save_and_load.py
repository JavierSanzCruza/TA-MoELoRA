...
def get_peft_model_state_dict(
    ...
    # TUNER SPECIFIC CODE
    if config.peft_type in (PeftType.LORA, PeftType.MOELORA):
        ...
        to_return = {k: v for k, v in to_return.items() if (("lora_" in k or adapter_name in k) or ("bias" in k))} # change and to or to exclude adapter_bias
