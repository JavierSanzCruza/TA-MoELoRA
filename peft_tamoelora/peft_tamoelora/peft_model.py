    ...
    **Attributes**:
    ...
    def from_pretrained(
        ...
        **kwargs: Any,
        ...
        if 'turn_off_last_layer_expert' in kwargs:
            config.turn_off_last_layer_expert = kwargs['turn_off_last_layer_expert']
...
class PeftModelForCausalLM(PeftModel):
    ...
    def generate(self, *args, **kwargs):
        peft_config = self.active_peft_config
        if self.peft_config[self.active_adapter].peft_type == PeftType.MOELORA:
            if self.peft_config[self.active_adapter].task_embedding_model:
                kwargs["task_ids"] = self.base_model.get_task_embeddings(kwargs['input_ids'])
    ...
    def prepare_inputs_for_generation(self, *args, task_ids: Optional[torch.Tensor] = None, **kwargs):
        ...
        if peft_config.peft_type == PeftType.MOELORA:
