...
from ...utils.integrations import dequantize_module_weight, gather_params_ctx, get_bnb_param_type
...
class Linear(nn.Module, LoraLayer):
    ...
    def forward(self, x: torch.Tensor, task_ids=None, *args: Any, **kwargs: Any) -> torch.Tensor:
